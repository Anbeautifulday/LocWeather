...
import cn.edu.cqupt.loc_whether.permission.CheckPermissionsActivity;
import cn.edu.cqupt.loc_whether.weatherbean.Weather;
import cn.edu.cqupt.loc_whether.weatherbean.WeatherService;
...
public class MapActivity extends CheckPermissionsActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.et_search_keyword).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                searchFragment.show(getSupportFragmentManager(),SearchFragment.TAG);
            }
